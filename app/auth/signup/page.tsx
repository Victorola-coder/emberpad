        ...
        <div className="relative z-10 w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      <EyeIcon
                        fill={showConfirmPassword ? "white" : "#94A3B8"}
                      />
                    </button>
                  </div>
                </div>
          ...
          >
            <div className="text-center">
              <div className="w-8 h-8 mx-auto mb-2 rounded-lg bg-gradient-to-r from-ember-400 to-ember-600 flex items-center justify-center">
                <Target className="w-4 h-4 text-white" />
              </div>
              <p className="text-sm text-dark-400">Track Goals</p>
            </div>
            <div className="text-center">
              <div className="w-8 h-8 mx-auto mb-2 rounded-lg bg-gradient-to-r from-ocean-400 to-ocean-600 flex items-center justify-center">
                <Sparkles className="w-4 h-4 text-white" />
              </div>
              <p className="text-sm text-dark-400">Get Reminders</p>
            </div>
            <div className="text-center">
              <div className="w-8 h-8 mx-auto mb-2 rounded-lg bg-gradient-to-r from-success-400 to-success-600 flex items-center justify-center">
                <CheckCircle className="w-4 h-4 text-white" />
              </div>
              <p className="text-sm text-dark-400">Stay Accountable</p>
            </div>
          </motion.div>
        </div>
      </div>
